...
export default function GoalCard({ goal, onDelete, onUpdate }: any){
  ...
  return (
    <div className="goal card">
      ...
      <div style={{marginTop:8,fontSize:13}} className="muted">Deadline: {local.deadline || '—'} • {local.useValidator? 'Validator':'Solo'} {local.validatorEmail? '• validator: '+local.validatorEmail : ''}</div>
